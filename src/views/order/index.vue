  ...
  <div class="order-warrper">
          ...
          <div v-if="detailShow">
            ...
            <div class="form-row">
              ...
              <el-form-item label="详细地址">
                <el-input class="width-635" size="small" placeholder="请填写详细地址"></el-input>
              </el-form-item>
            </div>
            <div class="form-row">
    ...
    <el-dialog title="患者信息登记" :visible.sync="AddVisible" size="large">
              ...
              <el-form :inline="true" label-width="100px" class="demo-form-inline">
                ...
                <el-col :span="8">
                 ...
                 <el-row>
                  ...
                  <el-col :span="16">
                  <el-form-item label="详细地址：">
                    <el-input class="width-469" placeholder="请输入详细地址"></el-input>
                  </el-form-item>
                </el-col>
                </el-row>
                 <el-row>
      ...
      <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="PrintVisible = false">保存</el-button>
              </span>
...
.width-635{
  ...
  .fixed-body>p>span,.order-plus-row>span{
    display: inline-block;
    float: left;
    width: 130px;
  }

  .fixed-body>p>span.fixed-label,.order-plus-row>span.fixed-label{
    width: 60px;
  }
  .fixed-title{
    height: 30px;
