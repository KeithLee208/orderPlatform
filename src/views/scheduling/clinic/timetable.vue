                      ...
                      <el-popover open-delay="600" v-if="week.cbrqlx"  placement="bottom" width="200" trigger="hover">
                        <div class="fixed-info">
                          ...
                          <div class="fixed-footer">
                            <el-button @click="handleTableAdjust(week)" type="text" size="small" class="el-button ">出班调整</el-button>
...
<script>
    ...
    export default {
      ...
      methods:{
        ...
        //获取出报表数据
        getTableList(){
          this.$wnhttp("PAT.WEB.APPOINTMENT.SCHEDULE.Q02", {ksdm:'',mbdm:'',yydm:''}).then(data => {
