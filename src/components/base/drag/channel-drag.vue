        ...
        <transition-group :name="'flip-list'">
           <div v-for="(item,index) in channal" :key="item.num" class="channel-box" :class="item.type">
            ...
            <p v-if="item.edit==true" class="top">
              <input v-model="editnum" v-focus class="num-edit" type="text" v-on:keyup.enter="changenum(index)">
            </p>
               ...
               <i :class="item1.type">
                 ...
                 <p class="price">
                   <span class="ball-price pull-left" v-if="item1.editcan==false" @click="balledit(index)">{{item1.price}}</span>
                    <input v-if="item1.editcan==true" v-model="ballnum" v-focus class="ball-edit" type="text" v-on:keyup.enter="changeball(index)">
